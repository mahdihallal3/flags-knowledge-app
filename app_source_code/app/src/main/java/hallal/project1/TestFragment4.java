...
public class TestFragment4 extends Fragment {
    ...
    public void onStart() {
        ...
        if (view!=null) {
            ImageView imageView = view.findViewById(R.id.flag_image_view_4);
            TextView textView = view.findViewById(R.id.flag_name_text_view_4);
        ...
        Button button =view.findViewById(R.id.true_button_4);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userAnswer.equalsIgnoreCase(actualAnswer))
                {
                    ...
                    Intent intent=new Intent(getLayoutInflater().getContext(),TestActivity5.class);

                    intent.putExtra(TestActivity5.SCORE, score);
                    intent.putExtra(TestActivity5.ALREADY_DISPLAYED, displayed_already);
                    intent.putExtra(TestActivity5.PROBA, proba);
        ...
        Button button1= view.findViewById(R.id.false_button_4);
    ...
    public void onTimer()
    {
        ...
        TextView view2=view.findViewById(R.id.counter_text_view_4);
