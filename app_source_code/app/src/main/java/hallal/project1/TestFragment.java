...
public class TestFragment extends Fragment {
    ...
    private boolean[] displayed_already=new boolean [] {false,false,false,false,false,false,false,false,false,false};
    ...
    public void onStart() {
        ...
        if (view!=null) {
            ImageView imageView = view.findViewById(R.id.flag_image_view);
            TextView textView = view.findViewById(R.id.flag_name_text_view);
       ...
       Button button =view.findViewById(R.id.true_button);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userAnswer.equalsIgnoreCase(actualAnswer))
                {
                    ...
                    Intent intent=new Intent(getLayoutInflater().getContext(),TestActivity2.class);

                    intent.putExtra(TestActivity2.SCORE, score);
                    intent.putExtra(TestActivity2.ALREADY_DISPLAYED, displayed_already);
                    intent.putExtra(TestActivity2.PROBA, proba);
        ...
        Button button1= view.findViewById(R.id.false_button);
    ...
    public void onTimer()
    {
        ...
        TextView view2=view.findViewById(R.id.counter_text_view);
