...
public class TestFragment5 extends Fragment {
    ...
    public void onStart() {
        ...
        if (view!=null) {
            ImageView imageView = view.findViewById(R.id.flag_image_view_5);
            TextView textView = view.findViewById(R.id.flag_name_text_view_5);
        ...
        Button button =view.findViewById(R.id.true_button_5);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userAnswer.equalsIgnoreCase(actualAnswer))
                {
                    ...
                    Intent intent=new Intent(getLayoutInflater().getContext(), ResultActivity.class);
        ...
        Button button1= view.findViewById(R.id.false_button_5);
    ...
    public void onTimer()
    {
        ...
        TextView view2=view.findViewById(R.id.counter_text_view_5);
