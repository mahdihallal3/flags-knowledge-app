...
public class TestFragment3 extends Fragment {
    ...
    public void onStart() {
        ...
        if (view!=null) {
            ImageView imageView = view.findViewById(R.id.flag_image_view_3);
            TextView textView = view.findViewById(R.id.flag_name_text_view_3);
        ...
        Button button =view.findViewById(R.id.true_button_3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userAnswer.equalsIgnoreCase(actualAnswer))
                {
                    ...
                    Intent intent=new Intent(getLayoutInflater().getContext(),TestActivity4.class);

                    intent.putExtra(TestActivity4.SCORE, score);
                    intent.putExtra(TestActivity4.ALREADY_DISPLAYED, displayed_already);
                    intent.putExtra(TestActivity4.PROBA, proba);
        ...
        Button button1= view.findViewById(R.id.false_button_3);
    ...
    public void onTimer()
    {
        ...
        TextView view2=view.findViewById(R.id.counter_text_view_3);
